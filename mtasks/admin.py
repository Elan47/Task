...
class TaskAdmin(AdminAdvancedFiltersMixin, admin.ModelAdmin):
    list_display = ('number', 'title', 'user', 'assign','partner', 'created_at', 'deadline', 'priority', 'state')
    ...
    fieldsets = (               # Edition form
        (None,                   {'fields': (('title','partner') ,('user', 'assign'), 'deadline',
    ...
    def get_fieldsets(self, request, obj=None):
        ...
        if obj is None:
            fieldsets = (      # Creation form
                (None, {'fields': (('title', 'partner'), ('user','assign'), 'deadline', ('state', 'priority'), 'description')}),
            )
        return fieldsets
